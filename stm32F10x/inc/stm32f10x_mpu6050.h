...
#define dt 													((float)0.01) /* (72000000/7200*100) = 0.01 */
#define FK 													((float)0.02) /* коэффициент комплементарного фильтра */
#define FE 													((float)0.05) /* коэффициент фильтра энкодера */
...
#define AddressWrite								((uint8_t)0xD0)
#define AddressRead 							  ((uint8_t)0xD1)

#define PI 													((float)3.141592653589793238)
#define RAD 												((float)(180.0f / PI))
#define DEGRAD 											((float)0.017453292519943295)
